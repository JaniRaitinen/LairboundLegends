# Muuttujien tilalle sit joku haku mil löydetään oikeet arvot.

nimi = 'pertti'
sijainti = 'Helsinki-Vantaa Lairport'

sanakirja = {
    "introLore": "Through a rift in time and space, you were transported to the fantastical world of Eldaria, "
                 "a world filled with dragons and elemental magic. Eldaria's scholars interpret this event as the "
                 "fulfillment of an ancient prophecy, designating you as the new Dragonbound, tasked with raising the "
                 "youth of the dragons, and quiding them through their journey to Dragonhood. The Dracarers, "
                 "who are the caretakers and guardians of the dragon hatchlings in Eldaria, have decided that you "
                 "will bond with one of their young Dragons, and together you will soar to the skies of destiny.",
    "difficultySelection": "The Dracarers have always known that every young dragon is an individual, and you will "
                           "choose your companion from among the youth of the dragons.",
    "namingYourDragon": "The fate of the Dragonbound is to be as one with their dragon companion. It is tradition in "
                        "Eldaria, that upon embarking on their journey the Dragonbound will gift their companion a "
                        "name. The name of your dragon will echo through eternity with the legends of your journey, "
                        "so choose wisely. My dragon will be known as:",
    ...
    "riddleStarter": [f"{nimi} looks at you and says: ", f"Your companion talks to you: ",
    ...
    "riddle": {"1": ["In a place where cacti rise, My heart's true destination, can you trace?",
               ...
               "6": ["Where azure stretches, free of clouds so wide, Where's the land where clear skies ever bide?",
               ...
               "8": ["In this place where gales embrace the wide, Where's the realm where air, untamed, do ride?",
    ...
    "lairportArrival": [f"You and {nimi} arrive at {sijainti}.",
    ...
    "rest": [f"You and {nimi} take a long rest to replenish your stamina.",
    ...
    "backHome": f"After long years travelling the world with your Dragon companion {nimi}, you’ve finally back at "
                f"your home lair.\n"
    ...
    "endGame": f"The legacy of Eldoria will live on while you’re gone. "
               f"Fates will see that you’ll still return to roam the skies with your faithful {nimi} and meet the "
